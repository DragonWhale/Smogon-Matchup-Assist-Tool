...
function loadQuestion() {
  ...
  document.getElementById('bottomarea').innerHTML = '<h5>Current question: ' + (question + 1) + '</h5><h5> Season: ' + team[1] + '</h5><h5>Current Score: ' + score + '</h5><h5>Previous result: ' + previousAns + '</h5>';

  answer = team[8];
}

function loadResults() {
  document.getElementById('centerarea').innerHTML = '<h4>You scored <br> ' + score + ' out of 10!</h4>';
  gameRunning = false;
